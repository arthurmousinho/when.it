/*
  ...
  - The values [EMBEDDED] on the enum `document_status` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "document_status_new" AS ENUM ('UPLOADED', 'EMBBEDED');
